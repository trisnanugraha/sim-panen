<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tabel-budidaya").DataTable({
            "responsive": true,
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Budidaya Masih Kosong"
            },
            ...
            "ajax": {
                "url": "<?php echo site_url('budidaya/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function add() {
        ...
        $('.modal-title').text('Tambah Budidaya'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text('Ubah Budidaya'); // Set title to Bootstrap modal title
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('budidaya/insert') ?>";
        } else {
            url = "<?php echo site_url('budidaya/update') ?>";
        }
            ...
            success: function(data) {
                ...
                if (data.status) //if success close modal and reload ajax table
                {
                    ...
                    if (save_method == 'add') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Data Budidaya Berhasil Disimpan!'
                        });
                    } else if (save_method == 'update') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Data Budidaya Berhasil Diubah!'
                        });
                    }
                } else {
